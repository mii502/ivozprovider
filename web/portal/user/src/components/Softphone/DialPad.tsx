...
interface DialPadProps {
  ...
  disabled?: boolean;
  /** Play DTMF tone on button press (default: true) */
  playSound?: boolean;
}
...
const DialPad = ({ onDigit, disabled = false, playSound = true }: DialPadProps): JSX.Element => {
  ...
  const handleMouseDown = useCallback(
    (key: KeyConfig) => {
      ...
      // Play tone immediately on press for responsive feedback
      if (playSound) {
        playTone(key.digit);
      }
    ...
    [disabled, onDigit, playSound, playTone]
  );
